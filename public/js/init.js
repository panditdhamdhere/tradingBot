      ...
      frenifyChat: function () {
        ...
        var n = {
          ...
          doc: {
            type: "url",
            description:
              "visit online documentation for TechWave HTML template",
            append: !1,
          ...
          pass: {
            type: "password",
            description:
              "if you want to get strong password I can generate it for you, write <frenify_main>/pass 20</frenify_main> to get a 20 character password",
            append: !0,
          },
          joke: {
            type: "joke",
        ...
        var l =
          "<p>Hello.</p><p>I am Frenify Bot. After purchasing the template, you can delete me easily. I understand some commands. You just select one of the commands and write here.</p><p>Here is the list of commands:</p>" +
          (o += "</ul>") +
          "<p>We are trying for you. We try to make unique themes and templates with excellent functionality and excellent design.</p>";
        n.welcome.text = l;
        var h = [
